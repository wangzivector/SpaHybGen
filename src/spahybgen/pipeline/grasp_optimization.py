...
if __name__ == '__main__':
    ...
    robot_name, hand_scale, init_rand_scale = 'softpneu3f', 1.0, 0.2
    ...
    inferred_result = np.load('visualdata/std_inference_result_from_clutter.npy')
    result_filedir = 'visualdata/'
